...
<section class="car-crash-section">
  <div class="row space-padding-right space-padding-left">
    ...
    <div class="col-md-6 col-sm-12">
      <h3 class="heading-red-title car-crash-two-col"><?= get_field('car_accident_-_heading_2'); ?></h3>
      <p class="line-height-text text-size"><?= get_field('car_accident_-_text_2'); ?></p>
    </div>
    <div class="col-md-6 col-sm-12">
      <h3 class="heading-red-title car-crash-two-col"><?= get_field('car_accident_-_heading_3'); ?></h3>
...
<section class="car-accident-section ">
  ...
  <div class="four-col-section ">
    <h3 class="heading-red-title"><?= get_field('car_accident_heading_4'); ?></h3>
    <p class="line-height-text text-size"><?= get_field('car_accident_text_4'); ?></p>
  </div>
  <div class="four-col-section">
    <h3 class="heading-red-title"><?= get_field('car_accident_heading_5'); ?></h3>
    <p class="line-height-text text-size"><?= get_field('car_accident_text_5'); ?></p>
  </div>
  <div class="four-col-section">
    <h3 class="heading-red-title"><?= get_field('car_accident_heading_6'); ?></h3>
  ...
  <div class="car-damage-body space-padding-right space-padding-left">
    ...
    <div class="row">
        ...
        <div class="col-xl-6 col-sm-12">
          <h3 class="heading-red-title min-height-col"><?= get_field('economic_damage_-_heading_1'); ?></h3>
          <p class="line-height-text text-size"><?= get_field('economic_damage_-_text_1'); ?></p>
        </div>
        <div class="col-xl-6 col-sm-12">
          <h3 class="heading-red-title min-height-col"><?= get_field('economic_damage_-_heading_2'); ?></h3>
  ...
  <div class="car-recovery-body">
      ...
      <div class="row">
        <div class="col-md-12 car-recovery-col">
          ...
          <p class="reduce-min-height"><?= get_field('car_recovery_-_text_4'); ?></p>
...
<div class="car-recovery-row space-padding-left ">
  ...
  <div class="col-md-12 car-recovery-col">
    <div><?= get_field('car_recovery_below_text_5'); ?></div>
  </div>
</div>
</div>
</div>
